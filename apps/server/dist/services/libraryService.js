...
exports.fetchSeriesList = fetchSeriesList;
exports.fetchSerieDetail = fetchSerieDetail;
exports.resolveEpisodeEmbed = resolveEpisodeEmbed;
const cheerio = __importStar(require("cheerio"));
const LACARTOONS_BASE_URL = 'https://www.lacartoons.com';
// ── Static config ────────────────────────────────────────────────────────────
// eslint-disable-next-line @typescript-eslint/no-var-requires
const libraryData = require('../db/library.json');
// ── In-memory cache ──────────────────────────────────────────────────────────
 ...
 */
async function fetchSerieDetail(serieId) {
 ...
 */
async function resolveEpisodeEmbed(episodePath) {
